...
<form id="quotation"  class="form m-5" action="" method="POST">
    <div class="card shadow mb-4">
        <div class="card-body p-4">
            ...
            <input type="hidden" name="productCost" id="productCost" value="">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="structureType" id="structure" rows="3"  
                          placeholder="Describa la estructura requerida"></textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="structureCost" 
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <span class="input-group-text">$</span>
                    <input type="number" class="form-control" name="distanceCost" 
                           id="travelCost" placeholder="400" required>
                </div>
            </div>
            
            <!-- Botón de generar -->
            <button type="submit" class="btn btn-primary w-100 py-2" name="transaction" value="add">
